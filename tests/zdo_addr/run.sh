...
echo "run ns-3"
../../devtools/network_simulator/network_simulator --nNode=2 --pipeName=/tmp/aaa 1>ns.txt 2>&1 &
PipePID=$!

sleep 5

echo "run coordinator"
./zdo_test_nwk_addr_zc /tmp/aaa0.write /tmp/aaa0.read &
coordPID=$!
wait_for_start zc
...
echo "run router"
./zdo_test_nwk_addr_zr /tmp/aaa1.write /tmp/aaa1.read &
routerPID=$!
wait_for_start zr

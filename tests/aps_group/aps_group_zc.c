...
#else
zb_ieee_addr_t g_r2_addr = {0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00};
#endif
...
void zc_send_grp(zb_uint8_t param) ZB_CALLBACK;
...
void group_add_conf4(zb_uint8_t param) ZB_CALLBACK
{
  ZB_SCHEDULE_ALARM(zc_send_grp, param, SEND_TMOUT);
}

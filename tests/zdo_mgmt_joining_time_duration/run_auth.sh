...
./zdo_join_duration_zc /tmp/znode0.write /tmp/znode0.read auth &
c_pid=$!
wait_for_start zc
echo ZC STARTED OK

echo "run zr"
./zdo_join_duration_zr /tmp/znode1.write /tmp/znode1.read auth &
r_pid=$!
wait_for_start zr
echo ZR STARTED OK
...
echo "run zed"
./zdo_join_duration_zed /tmp/znode2.write /tmp/znode2.read auth &
ed_pid=$!

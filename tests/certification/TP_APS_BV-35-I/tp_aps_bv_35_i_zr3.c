...
#ifndef ZB8051
  ZB_INIT("zdo_zr3_", argv[1], argv[2]);
#else
  ZB_INIT("zdo_zr3_", "2", "2");
#endif
...
void bind_req(zb_uint8_t param) ZB_CALLBACK
{
  ...
  zb_apsme_add_group_req_t *req = ZB_GET_BUF_PARAM(buf, zb_apsme_add_group_req_t);

  TRACE_MSG(TRACE_COMMON1, "bind_req", (FMT__0));

  req->group_address = param;
  req->endpoint = 0xf0;
...
void zb_zdo_startup_complete(zb_uint8_t param) ZB_CALLBACK
{
  ...
  {
    ZB_SCHEDULE_CALLBACK(bind_req, 0x04);
